...
public class RegistrationPage extends BaseTest{
    ...
    public void testSuccessfulRegistration() throws InterruptedException {
    	webDriver.findElement(By.xpath("/html/body/app-root/app-login/body/div/div/p/a")).click();
    	webDriver.findElement(By.id("name")).sendKeys("Moni");
        Thread.sleep(2000);
        webDriver.findElement(By.id("mobilenumber")).sendKeys("9894646746");
        Thread.sleep(2000);
        webDriver.findElement(By.id("email")).sendKeys("moni@gmail.com");
        Thread.sleep(2000);
        webDriver.findElement(By.id("password")).sendKeys("Moni@14");
        Thread.sleep(2000);
        webDriver.findElement(By.id("confirmpassword")).sendKeys("Moni@14");
        Thread.sleep(2000);
